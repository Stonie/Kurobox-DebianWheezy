...
unless(defined(&_ASM_POWERPC_PTRACE_H)) {
    ...
    eval 'sub PPC_PTRACE_GETHWDBGINFO () {0x89;}' unless defined(&PPC_PTRACE_GETHWDBGINFO);
    eval 'sub PPC_PTRACE_SETHWDEBUG () {0x88;}' unless defined(&PPC_PTRACE_SETHWDEBUG);
    eval 'sub PPC_PTRACE_DELHWDEBUG () {0x87;}' unless defined(&PPC_PTRACE_DELHWDEBUG);
    unless(defined(&__ASSEMBLY__)) {
    }
    eval 'sub PPC_DEBUG_FEATURE_INSN_BP_RANGE () {0x1;}' unless defined(&PPC_DEBUG_FEATURE_INSN_BP_RANGE);
    eval 'sub PPC_DEBUG_FEATURE_INSN_BP_MASK () {0x2;}' unless defined(&PPC_DEBUG_FEATURE_INSN_BP_MASK);
    eval 'sub PPC_DEBUG_FEATURE_DATA_BP_RANGE () {0x4;}' unless defined(&PPC_DEBUG_FEATURE_DATA_BP_RANGE);
    eval 'sub PPC_DEBUG_FEATURE_DATA_BP_MASK () {0x8;}' unless defined(&PPC_DEBUG_FEATURE_DATA_BP_MASK);
    unless(defined(&__ASSEMBLY__)) {
    }
    eval 'sub PPC_BREAKPOINT_TRIGGER_EXECUTE () {0x1;}' unless defined(&PPC_BREAKPOINT_TRIGGER_EXECUTE);
    eval 'sub PPC_BREAKPOINT_TRIGGER_READ () {0x2;}' unless defined(&PPC_BREAKPOINT_TRIGGER_READ);
    eval 'sub PPC_BREAKPOINT_TRIGGER_WRITE () {0x4;}' unless defined(&PPC_BREAKPOINT_TRIGGER_WRITE);
    eval 'sub PPC_BREAKPOINT_TRIGGER_RW () {( &PPC_BREAKPOINT_TRIGGER_READ |  &PPC_BREAKPOINT_TRIGGER_WRITE);}' unless defined(&PPC_BREAKPOINT_TRIGGER_RW);
    eval 'sub PPC_BREAKPOINT_MODE_EXACT () {0x;}' unless defined(&PPC_BREAKPOINT_MODE_EXACT);
    eval 'sub PPC_BREAKPOINT_MODE_RANGE_INCLUSIVE () {0x1;}' unless defined(&PPC_BREAKPOINT_MODE_RANGE_INCLUSIVE);
    eval 'sub PPC_BREAKPOINT_MODE_RANGE_EXCLUSIVE () {0x2;}' unless defined(&PPC_BREAKPOINT_MODE_RANGE_EXCLUSIVE);
    eval 'sub PPC_BREAKPOINT_MODE_MASK () {0x3;}' unless defined(&PPC_BREAKPOINT_MODE_MASK);
    eval 'sub PPC_BREAKPOINT_CONDITION_MODE () {0x3;}' unless defined(&PPC_BREAKPOINT_CONDITION_MODE);
    eval 'sub PPC_BREAKPOINT_CONDITION_NONE () {0x;}' unless defined(&PPC_BREAKPOINT_CONDITION_NONE);
    eval 'sub PPC_BREAKPOINT_CONDITION_AND () {0x1;}' unless defined(&PPC_BREAKPOINT_CONDITION_AND);
    eval 'sub PPC_BREAKPOINT_CONDITION_EXACT () { &PPC_BREAKPOINT_CONDITION_AND;}' unless defined(&PPC_BREAKPOINT_CONDITION_EXACT);
    eval 'sub PPC_BREAKPOINT_CONDITION_OR () {0x2;}' unless defined(&PPC_BREAKPOINT_CONDITION_OR);
    eval 'sub PPC_BREAKPOINT_CONDITION_AND_OR () {0x3;}' unless defined(&PPC_BREAKPOINT_CONDITION_AND_OR);
    eval 'sub PPC_BREAKPOINT_CONDITION_BE_ALL () {0xff0000;}' unless defined(&PPC_BREAKPOINT_CONDITION_BE_ALL);
    eval 'sub PPC_BREAKPOINT_CONDITION_BE_SHIFT () {16;}' unless defined(&PPC_BREAKPOINT_CONDITION_BE_SHIFT);
    eval 'sub PPC_BREAKPOINT_CONDITION_BE {
        my($n) = @_;
	    eval q((1<<(($n)+ &PPC_BREAKPOINT_CONDITION_BE_SHIFT)));
    }' unless defined(&PPC_BREAKPOINT_CONDITION_BE);
}
1;
