...
unless(defined(&SYS_multiplexer)) {
    sub SYS_multiplexer () {	 &__NR_multiplexer;}
}
...
unless(defined(&SYS_rtas)) {
    sub SYS_rtas () {	 &__NR_rtas;}
}
...
unless(defined(&SYS_spu_create)) {
    sub SYS_spu_create () {	 &__NR_spu_create;}
}
unless(defined(&SYS_spu_run)) {
    sub SYS_spu_run () {	 &__NR_spu_run;}
}
...
unless(defined(&SYS_subpage_prot)) {
    sub SYS_subpage_prot () {	 &__NR_subpage_prot;}
}
unless(defined(&SYS_swapcontext)) {
    sub SYS_swapcontext () {	 &__NR_swapcontext;}
}
...
unless(defined(&SYS_sys_debug_setcontext)) {
    sub SYS_sys_debug_setcontext () {	 &__NR_sys_debug_setcontext;}
}
...
unless(defined(&SYS_tuxcall)) {
    sub SYS_tuxcall () {	 &__NR_tuxcall;}
}
