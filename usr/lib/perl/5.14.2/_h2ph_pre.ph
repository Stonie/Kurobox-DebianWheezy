...
unless (defined &PPC) { sub PPC() { 1 } }

unless (defined &_ARCH_PPC) { sub _ARCH_PPC() { 1 } }

unless (defined &_BIG_ENDIAN) { sub _BIG_ENDIAN() { 1 } }

unless (defined &_CALL_SYSV) { sub _CALL_SYSV() { 1 } }
...
unless (defined &__BIG_ENDIAN__) { sub __BIG_ENDIAN__() { 1 } }

unless (defined &__BYTE_ORDER__) { sub __BYTE_ORDER__() { 4321 } }
...
unless (defined &__DBL_DENORM_MIN__) { sub __DBL_DENORM_MIN__() { "\(double\)4\.94065645841246544176568792868221e\-324L" } }

unless (defined &__DBL_DIG__) { sub __DBL_DIG__() { 15 } }

unless (defined &__DBL_EPSILON__) { sub __DBL_EPSILON__() { "\(double\)2\.22044604925031308084726333618164e\-16L" } }
...
unless (defined &__DBL_MAX__) { sub __DBL_MAX__() { "\(double\)1\.79769313486231570814527423731704e\+308L" } }

unless (defined &__DBL_MIN_10_EXP__) { sub __DBL_MIN_10_EXP__() { -307 } }

unless (defined &__DBL_MIN_EXP__) { sub __DBL_MIN_EXP__() { -1021 } }

unless (defined &__DBL_MIN__) { sub __DBL_MIN__() { "\(double\)2\.22507385850720138309023271733240e\-308L" } }
...
unless (defined &__DECIMAL_DIG__) { sub __DECIMAL_DIG__() { 33 } }
...
unless (defined &__FLOAT_WORD_ORDER__) { sub __FLOAT_WORD_ORDER__() { 4321 } }

unless (defined &__FLT_DECIMAL_DIG__) { sub __FLT_DECIMAL_DIG__() { 9 } }

unless (defined &__FLT_DENORM_MIN__) { sub __FLT_DENORM_MIN__() { 1.40129846432481707092372958328992e-45 } }

unless (defined &__FLT_DIG__) { sub __FLT_DIG__() { 6 } }

unless (defined &__FLT_EPSILON__) { sub __FLT_EPSILON__() { 1.19209289550781250000000000000000e-7 } }
...
unless (defined &__FLT_MAX__) { sub __FLT_MAX__() { 3.40282346638528859811704183484517e+38 } }

unless (defined &__FLT_MIN_10_EXP__) { sub __FLT_MIN_10_EXP__() { -37 } }

unless (defined &__FLT_MIN_EXP__) { sub __FLT_MIN_EXP__() { -125 } }

unless (defined &__FLT_MIN__) { sub __FLT_MIN__() { 1.17549435082228750796873653722225e-38 } }
...
unless (defined &__HAVE_BSWAP__) { sub __HAVE_BSWAP__() { 1 } }
...
unless (defined &__LDBL_DENORM_MIN__) { sub __LDBL_DENORM_MIN__() { 4.94065645841246544176568792868221e-324 } }

unless (defined &__LDBL_DIG__) { sub __LDBL_DIG__() { 31 } }

unless (defined &__LDBL_EPSILON__) { sub __LDBL_EPSILON__() { 4.94065645841246544176568792868221e-324 } }
...
unless (defined &__LDBL_MANT_DIG__) { sub __LDBL_MANT_DIG__() { 106 } }

unless (defined &__LDBL_MAX_10_EXP__) { sub __LDBL_MAX_10_EXP__() { 308 } }

unless (defined &__LDBL_MAX_EXP__) { sub __LDBL_MAX_EXP__() { 1024 } }

unless (defined &__LDBL_MAX__) { sub __LDBL_MAX__() { 1.79769313486231580793728971405301e+308 } }

unless (defined &__LDBL_MIN_10_EXP__) { sub __LDBL_MIN_10_EXP__() { -291 } }

unless (defined &__LDBL_MIN_EXP__) { sub __LDBL_MIN_EXP__() { -968 } }

unless (defined &__LDBL_MIN__) { sub __LDBL_MIN__() { 2.00416836000897277799610805135016e-292 } }

unless (defined &__LONGDOUBLE128) { sub __LONGDOUBLE128() { 1 } }

unless (defined &__LONG_DOUBLE_128__) { sub __LONG_DOUBLE_128__() { 1 } }
...
unless (defined &__PPC) { sub __PPC() { 1 } }

unless (defined &__PPC__) { sub __PPC__() { 1 } }
...
unless (defined &__powerpc) { sub __powerpc() { 1 } }

unless (defined &__powerpc__) { sub __powerpc__() { 1 } }
...
unless (defined &powerpc) { sub powerpc() { 1 } }
