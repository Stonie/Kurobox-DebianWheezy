...
unless(defined(&_ASM_POWERPC_SOCKET_H)) {
    eval 'sub _ASM_POWERPC_SOCKET_H () {1;}' unless defined(&_ASM_POWERPC_SOCKET_H);
    ...
    eval 'sub SO_RCVLOWAT () {16;}' unless defined(&SO_RCVLOWAT);
    eval 'sub SO_SNDLOWAT () {17;}' unless defined(&SO_SNDLOWAT);
    eval 'sub SO_RCVTIMEO () {18;}' unless defined(&SO_RCVTIMEO);
    eval 'sub SO_SNDTIMEO () {19;}' unless defined(&SO_SNDTIMEO);
    eval 'sub SO_PASSCRED () {20;}' unless defined(&SO_PASSCRED);
    eval 'sub SO_PEERCRED () {21;}' unless defined(&SO_PEERCRED);
